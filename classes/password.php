...
class Password
{
	...
	protected $itoa64, $iterations, $portable, $random;

	public function __construct($iterations = 8, $portable = false)
	{

		$this->itoa64     = './0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
		$this->iterations = ($iterations < 4 or $iterations > 31) ? 8 : $iterations;
		$this->portable   = $portable;
		$this->random     = microtime();

		function_exists('getmypid') and $this->random .= getmypid();
	...
	public function hash($password)
	{
		...
		if (CRYPT_BLOWFISH === 1 and $this->portable === false)
		{
		...
		elseif (CRYPT_EXT_DES === 1 and $this->portable === false)
		{
	...
	protected function gensalt_extended($input)
	{
		...
		$count_log2 = min($this->iterations + 8, 24);
